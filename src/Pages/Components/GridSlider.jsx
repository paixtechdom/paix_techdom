...
return(
        ...
        <div  className={`grid grid-cols-1 lg:grid-cols-2 w-11/12 lg:w-9/12 gap-9`}>
            ...
            {
                data.map((d, i) => (
                    <Parallax key={i} id={d.id} className='h-full flex flex-col border border-blue-900 bg-secondary bg-opacity-80 p-5 md:p-9 rounded-xl gap-2 leading-relaxed tracking-wide' index={i}>
